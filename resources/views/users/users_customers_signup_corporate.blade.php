                    ...
                    <div class="row px-3">
                        ...
                        <div class="col-md-4 col-sm-12 mb-3">
                            <div class="form-group position-relative">
                                <span class="input-icon"><img src="{{ asset('users/assets/images/icons/company.png') }}" alt="icon" class="img-fluid"></span>
                        ...
                        <div class="col-md-4 col-sm-12 mb-3">
                            <div class="form-group position-relative">
                                ...
                                <input type="text" class="form-control" placeholder="Representative name" name="representative_name" id="representative_name">
                        ...
                        <div class="col-md-4 col-sm-12 mb-3">
                            <div class="form-group position-relative">
                                <input type="tel" class="form-control w-100" placeholder="Phone number" name="phone_number" id="phone_number" maxlength="11" oninput="this.value=this.value.replace(/[^0-9]/g,'');">
            ...
            $(document).ready(function() {
                ...
                $("#frm_signup").validate({
                    ...
                    messages: {
                        ...
                        representative_name:  { required: "This field is required.", minlength: "At least 3 characters." },

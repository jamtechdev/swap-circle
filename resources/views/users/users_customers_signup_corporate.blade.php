...
@section('title', ($brandName ?? 'Swap Circle') . ' — Corporate Sign Up')
@section('back_url', url('/users/signup'))
@section('back_label', 'Back to account type')

@php
    $heroTitle = 'Register your<br>organisation.';
    $heroText = 'Set up a corporate account to manage business transactions, products, and community exchange at scale.';
@endphp
...
@section('content')
    <div class="text-center lg:text-left">
        ...
        <h1 class="mt-4 font-display text-2xl font-bold text-forest sm:text-3xl">Corporate registration</h1>
    ...
    <form id="frm_signup" class="mt-8 space-y-8" novalidate>
        ...
        <div>
            ...
            <div class="grid gap-4 sm:grid-cols-2">
                <div class="sm:col-span-2">
                    <label for="company_name" class="auth-label">Company name *</label>
                    <input type="text" id="company_name" name="company_name" class="auth-input !pl-4" placeholder="Acme Ltd">
                    <span class="auth-error" id="error_company_name"></span>
                </div>
                <div>
                    <label for="representative_name" class="auth-label">Representative name *</label>
                    <input type="text" id="representative_name" name="representative_name" class="auth-input !pl-4" placeholder="Full name">
                    <span class="auth-error" id="error_representative_name"></span>
                </div>
                <div>
                    <label for="email" class="auth-label">Business email *</label>
        ...
        <div>
            <p class="auth-section-title">Business address</p>
            <div class="grid gap-4 sm:grid-cols-2">
                <div class="sm:col-span-2">
                    <label for="street" class="auth-label">Street address *</label>
                    <input type="text" id="street" name="street" class="auth-input !pl-4" placeholder="Office address">
                    <span class="auth-error" id="error_street"></span>
                </div>
                <div>
                    <label for="city_state" class="auth-label">City / State *</label>
                    <input type="text" id="city_state" name="city_state" class="auth-input !pl-4" placeholder="City">
                    <span class="auth-error" id="error_city_state"></span>
                </div>
                <div>
                    <label for="country" class="auth-label">Country *</label>
                    <input type="text" id="country" name="country" class="auth-input !pl-4" placeholder="Country">

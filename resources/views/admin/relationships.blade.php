            ...
            <div class="col-md-12 mb-n5">
                <div class="col-sm-12 p-md-0">
                    <div class="col-sm-12 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        @section('titleBar')
                        <span class="ml-2">Manage Relationships</span>
                        @endsection
                    </div>
                </div>
                <!-- modal add start -->
                        ...
                        <div class="modal-content">
                            <div class="modal-body p-4">
                                <div class="d-flex align-items-center mb-4">
                                    <h4 class="">Add Relationship</h4>
                                </div>
                                <form method="post" action="{{ url('/admin/relationships_add') }}">
                                    @csrf
                                    <div class="row mt-0">
                                        <div class="col-lg-12 col-md-6">
                                            <div class="form-group mb-4">
                                                <input type="text" class="form-control" placeholder="Enter Relationship" name="name" required>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="modal fade" id="modal_edit{{ $item->relationships_id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                         <div class="modal-dialog modal-md modal-dialog-centered">
                                                            <div class="modal-content">
                                                                <div class="modal-body p-4">
                                                                    <div class="d-flex align-items-center mb-4">
                                                                        <h4 class="">Edit Relationship</h4>
                                                                    </div>
                                                                    <form method="post" action="{{ url('/admin/relationships_edit') }}">
                                                                        @csrf
                                                                        <div class="row mt-0">
                                                                            <div class="col-lg-12 col-md-6">
                                                                                <div class="form-group mb-4">
                                                                                    <input type="text" class="form-control" value="{{ $item->name }}" placeholder="Enter Relationship" name="edit_name" required>
                                                                                </div>
                                                                            </div>
                                                                            <input type="hidden" name="relationships_id" value="{{ $item->relationships_id }}" readonly>
                                                                        </div>
                                                                        <div class="d-flex justify-content-end mt-3">
                                                                            <button type="submit" class="btn btn-primary btn-login mr-2">Save</button>
                                                                            <button type="button" class="btn btn-danger btn-login" data-dismiss="modal">Close</button>

                                               ...
                                               @foreach($tasks_types as $key => $item)
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td> 
                                                        ...
                                                        <a class="btn btn-info" data-toggle="modal" data-target="#modal_edit{{ $item->tasks_types_id }}" title="Edit"><i class="fas fa-edit"></i></a>
                                                        @if($item->status == 'Active')
                                                            <a href="{{ url('/admin/tasks_types_update/Inactive/' . $item->tasks_types_id) }}" class="btn btn-warning" title="Deactivate"><i class="fas fa-times"></i></a>
                                                        @endif 

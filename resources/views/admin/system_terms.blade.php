                            ...
                            <div class="basic-form">
                                <form class="form-horizontal bordered-row" enctype="multipart/form-data" method="post" action="{{url('/admin/system_settings_edit')}}">
                                    ...
                                    <div class="col-xl-12 form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <textarea rows="5" class="input-mask form-control" name="{{ $system_settings[17]->type }}" required>{{ $system_settings[17]->description }}</textarea>
                                        </div>
                                    </div>
                                   
                                    <div class="col-xl-12 form-group">
                                        <div class="col-sm-12">
                                            <input type="hidden" class="input-mask form-control" name="page_name" value="system_terms" required>
